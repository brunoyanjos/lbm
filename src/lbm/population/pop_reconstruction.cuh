...
#pragma unroll
    for (int i = 0; i < Stencil::Q; ++i)
    {
        ...
        const real_t uxA = ux + BETA * omegaB * omegaA * n.x * Stencil::cs2 / MASS_A;
        const real_t uyA = uy + BETA * omegaB * omegaA * n.y * Stencil::cs2 / MASS_A;

        const real_t uxB = ux - BETA * omegaA * omegaB * n.x * Stencil::cs2 / MASS_B;
        const real_t uyB = uy - BETA * omegaA * omegaB * n.y * Stencil::cs2 / MASS_B;
        ...
        popA[i] = Stencil::w(i) * rhoA *
                  (r::one +
                   ...
                   scale_factor<MomentId::mxx>() * (mxx + ux * ux + THETA_A) * hermite<MomentId::mxx>(i) +
                   scale_factor<MomentId::mxy>() * (mxy + ux * uy) * hermite<MomentId::mxy>(i) +
                   scale_factor<MomentId::myy>() * (myy + uy * uy + THETA_A) * hermite<MomentId::myy>(i) +
                   ...
                   scale_factor<MomentId::mxxyy>() * (ux * ux * uy * uy + THETA_A * (ux * ux + uy * uy) - THETA_A) * hermite<MomentId::mxxyy>(i));
        ...
        popB[i] = Stencil::w(i) * rhoB *
                  (r::one +
                   ...
                   scale_factor<MomentId::mxx>() * (mxx + ux * ux + THETA_B) * hermite<MomentId::mxx>(i) +
                   scale_factor<MomentId::mxy>() * (mxy + ux * uy) * hermite<MomentId::mxy>(i) +
                   scale_factor<MomentId::myy>() * (myy + uy * uy + THETA_B) * hermite<MomentId::myy>(i) +
                   ...
                   scale_factor<MomentId::mxxyy>() * (ux * ux * uy * uy + THETA_B * (ux * ux + uy * uy) - THETA_B) * hermite<MomentId::mxxyy>(i));
    }
}
