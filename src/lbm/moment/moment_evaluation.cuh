...
#pragma unroll
    for (int i = 0; i < Stencil::Q; ++i)
    {
        ...
        M.mxx += (MASS_A * fiA + MASS_B * fiB) * hermite<MomentId::mxx>(i);
        M.mxy += (MASS_A * fiA + MASS_B * fiB) * hermite<MomentId::mxy>(i);
        M.myy += (MASS_A * fiA + MASS_B * fiB) * hermite<MomentId::myy>(i);
    }
    ...
    M.mxx -= TOTAL_MASS_DENSITY * M.ux * M.ux;
    M.mxy -= TOTAL_MASS_DENSITY * M.ux * M.uy;
    M.myy -= TOTAL_MASS_DENSITY * M.uy * M.uy;
