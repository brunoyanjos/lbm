...
constexpr real_t TAU = static_cast<real_t>(1); // static_cast<real_t>(0.5) + Stencil::as2 * VISC;
...
constexpr real_t MASS_A = r::one;
constexpr real_t MASS_B = real_t{10};
...
constexpr real_t VISC_RATIO = static_cast<real_t>(1.0);
