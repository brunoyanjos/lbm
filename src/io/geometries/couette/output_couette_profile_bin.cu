#include "output_couette_profile_bin.cuh"
...
namespace io
{
    ...
    void write_couette_profile(const LBMState &state, int t, const std::string &out_dir, const DomainTags &tags)
    {
        (void)tags;
